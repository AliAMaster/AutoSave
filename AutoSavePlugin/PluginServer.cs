...
{
    [Guid("f3d09bba-c3a4-400d-a1ad-6963bf40771b")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": AutoSavePlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");
        ...
        {
            Trace.TraceInformation(": AutoSavePlugin: deactivating... ");
